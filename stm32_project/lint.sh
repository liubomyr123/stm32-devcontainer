...
find /workspace/stm32_project/app -name "*.cpp" -o -name "*.hpp" | xargs clang-tidy \
    --config-file=/workspace/stm32_project/.clang-tidy \
    -p /workspace/stm32_project/stm32/build/Debug \
